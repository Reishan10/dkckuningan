                            ...
                            <div class="page-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto text-end float-end ms-auto download-grp">
                                        ...
                                        <a href="{{ route('pendaftaran.siaga.printPDF') }}" target="_blank"
                                            class="btn btn-primary">
        ...
        <script>
            $(document).ready(function() {
                ...
                var table = $('#datatable').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('pendaftaran.siaga.index') }}",
                    columns: [{
                            data: 'DT_RowIndex',
                            name: 'DT_RowIndex',
                            orderable: false,
                ...
                $('#filter').click(function() {
                    ...
                    table = $('#datatable').DataTable({
                        ...
                        serverSide: true,
                        ajax: {
                            url: "{{ route('pendaftaran.siaga.index') }}",
                            data: {
                ...
                $('body').on('click', '#btnDetail', function() {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{ url('/pendaftaran/siaga/detail/"+id+"') }}",
                        data: {
                            id: id
                        },
                        dataType: 'json',
                ...
                $('body').on('click', '#btnTerima', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "POST",
                                url: "{{ url('pendaftaran/siaga/terima') }}/" + id,
                                data: {
                                    id: id
                                },
                                dataType: 'json',
                ...
                $('body').on('click', '#btnTolak', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "POST",
                                url: "{{ url('pendaftaran/siaga/tolak') }}/" + id,
                                data: {
                                    id: id
                                },
                                dataType: 'json',
                ...
                $('body').on('click', '#btnHapus', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "DELETE",
                                url: "{{ url('pendaftaran/siaga/delete') }}/" + id,
                                data: {
                                    id: id
                                },
                                dataType: 'json',
