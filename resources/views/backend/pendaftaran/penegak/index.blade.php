        ...
        <script>
            $(document).ready(function() {
                ...
                var table = $('#datatable').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('pendaftaran.penegak.index') }}",
                    columns: [{
                            data: 'DT_RowIndex',
                            name: 'DT_RowIndex',
                            orderable: false,
                ...
                $('body').on('click', '#btnDetail', function() {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{ url('/pendaftaran/penegak/detail/"+id+"') }}",
                        data: {
                            id: id
                        },
                        dataType: 'json',
                ...
                $('body').on('click', '#btnTerima', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "POST",
                                url: "{{ url('pendaftaran/penegak/terima') }}/" + id,
                                data: {
                                    id: id
                                },
                                dataType: 'json',
                ...
                $('body').on('click', '#btnTolak', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "POST",
                                url: "{{ url('pendaftaran/penegak/tolak') }}/" + id,
                                data: {
                                    id: id
                                },
                                dataType: 'json',
                ...
                $('body').on('click', '#btnHapus', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "DELETE",
                                url: "{{ url('pendaftaran/penegak/delete') }}/" + id,
                                data: {
                                    id: id
                                },
                                dataType: 'json',
