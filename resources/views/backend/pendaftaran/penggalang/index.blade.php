                            ...
                            <div class="page-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto text-end float-end ms-auto download-grp">
                                        <a href="{{ route('pendaftaran.penggalang.print') }}" target="_blank"
                                            class="btn btn-primary">
                                            <i class="fas fa-print"></i>
                                        </a>
                                        <a href="{{ route('pendaftaran.penggalang.printPDF') }}" target="_blank"
                                            class="btn btn-primary">
        ...
        <script>
            $(document).ready(function() {
                ...
                var table = $('#datatable').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('pendaftaran.penggalang.index') }}",
                    columns: [{
                            data: 'DT_RowIndex',
                            name: 'DT_RowIndex',
                            orderable: false,
                ...
                $('#filter').click(function() {
                    ...
                    table = $('#datatable').DataTable({
                        ...
                        serverSide: true,
                        ajax: {
                            url: "{{ route('pendaftaran.penggalang.index') }}",
                            data: {
                ...
                $('body').on('click', '#btnDetail', function() {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{ url('/pendaftaran/penggalang/detail/"+id+"') }}",
                        data: {
                            id: id
                        },
                        dataType: 'json',
                ...
                $('body').on('click', '#btnTerima', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "POST",
                                url: "{{ url('pendaftaran/penggalang/terima') }}/" + id,
                                data: {
                                    id: id
                                },
                                dataType: 'json',
                ...
                $('body').on('click', '#btnTolak', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "POST",
                                url: "{{ url('pendaftaran/penggalang/tolak') }}/" + id,
                                data: {
                                    id: id
                                },
                                dataType: 'json',
                ...
                $('body').on('click', '#btnHapus', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "DELETE",
                                url: "{{ url('pendaftaran/penggalang/delete') }}/" + id,
                                data: {
                                    id: id
                                },
                                dataType: 'json',
