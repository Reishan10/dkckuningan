                            ...
                            <div class="page-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto text-end float-end ms-auto download-grp">
                                        <a href="{{ route('penilaian.pandega.print') }}" target="_blank"
                                            class="btn btn-primary">
                                            <i class="fas fa-print"></i>
                                        </a>
                                        <a href="{{ route('penilaian.pandega.printPDF') }}" target="_blank"
                                            class="btn btn-primary">
        ...
        <script>
            $(document).ready(function() {
                ...
                var table = $('#datatable').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('penilaian.pandega.index') }}",
                    columns: [{
                            data: 'DT_RowIndex',
                            name: 'DT_RowIndex',
                            orderable: false,
                ...
                $('#filter').click(function() {
                    ...
                    table = $('#datatable').DataTable({
                        ...
                        serverSide: true,
                        ajax: {
                            url: "{{ route('penilaian.pandega.index') }}",
                            data: {
                ...
                $('body').on('click', '#btnTerima', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "POST",
                                url: "{{ url('penilaian/pandega/terima') }}/" + id,
                                data: {
                                    id: id
                                },
                                dataType: 'json',
                ...
                $('body').on('click', '#btnTolak', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "POST",
                                url: "{{ url('penilaian/pandega/tolak') }}/" + id,
                                data: {
                                    id: id
                                },
                                dataType: 'json',
                 ...
                 $('body').on('click', '#btnPertimbangkan', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "POST",
                                url: "{{ url('penilaian/pandega/pertimbangkan') }}/" + id,
                                data: {
                                    id: id
                                },
                                dataType: 'json',
