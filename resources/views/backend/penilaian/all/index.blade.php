                            ...
                            <div class="page-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto text-end float-end ms-auto download-grp">
                                        <a href="{{ route('penilaian.all.print') }}" target="_blank"
                                            class="btn btn-primary">
                                            <i class="fas fa-print"></i>
                                        </a>
                                        <a href="{{ route('penilaian.all.printPDF') }}" target="_blank"
                                            class="btn btn-primary">
        ...
        <script>
            $(document).ready(function() {
                ...
                var table = $('#datatable').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('penilaian.all.index') }}",
                    columns: [{
                            data: 'DT_RowIndex',
                            name: 'DT_RowIndex',
                            orderable: false,
                ...
                $('body').on('click', '#btnPertimbangkan', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "POST",
                                url: "{{ url('penilaian/semua/pertimbangkan') }}/" + id,
                                data: {
                                    id: id
                                },
                                dataType: 'json',
