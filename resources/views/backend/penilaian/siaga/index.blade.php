                            ...
                            <div class="page-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto text-end float-end ms-auto download-grp">
                                        <a href="{{ route('penilaian.siaga.print') }}" target="_blank"
                                            class="btn btn-primary">
                                            <i class="fas fa-print"></i>
                                        </a>
                                        <a href="{{ route('penilaian.siaga.printPDF') }}" target="_blank"
                                            class="btn btn-primary">
            ...
            $(document).ready(function() {
                ...
                $('#filter').click(function() {
                    ...
                    table = $('#datatable').DataTable({
                        ...
                        serverSide: true,
                        ajax: {
                            url: "{{ route('penilaian.siaga.index') }}",
                            data: {
                ...
                $('body').on('click', '#btnTerima', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "POST",
                                url: "{{ url('penilaian/siaga/terima') }}/" + id,
                                data: {
                                    id: id
                                },
                                dataType: 'json',
                ...
                $('body').on('click', '#btnTolak', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "POST",
                                url: "{{ url('penilaian/siaga/tolak') }}/" + id,
                                data: {
                                    id: id
                                },
                                dataType: 'json',
                ...
                $('body').on('click', '#btnPertimbangkan', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "POST",
                                url: "{{ url('penilaian/siaga/pertimbangkan') }}/" + id,
                                data: {
                                    id: id
                                },
                                dataType: 'json',
