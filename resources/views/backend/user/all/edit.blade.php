                ...
                <div class="row align-items-center">
                    <div class="col-sm-12">
                        <div class="page-sub-header">
                            ...
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('pengguna.semua.index') }}">Semua Data</a></li>
                                    ...
                                    <div class="col-12 col-sm-6">
                                        <div class="form-group local-forms">
                                            ...
                                            <select name="type" id="type" class="form-control">
                                                ...
                                                <option value="0"
                                                    {{ $user->type == 'Administrator' ? 'selected' : '' }}>
                                                    Administrator</option>
                                                <option value="1" {{ $user->type == 'Juri' ? 'selected' : '' }}>Juri
                                                </option>
                                                <option value="2" {{ $user->type == 'Panitia' ? 'selected' : '' }}>
                                                    Panitia
                                                </option>
                                                <option value="3" {{ $user->type == 'Peserta' ? 'selected' : '' }}>
                                                    Peserta
                                                </option>
                                            </select>
                                            <small class="text-danger errorEmail"></small>
        ...
        $(document).ready(function() {
            ...
            $('#form').submit(function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ url('pengguna/semua/update/"+id+"') }}",
                    type: "POST",
                    dataType: 'json',
                    beforeSend: function() {
