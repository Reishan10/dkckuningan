...
@section('title', 'Edit Soal Penggalang')
@section('content')
                ...
                <div class="row align-items-center">
                    <div class="col-sm-12">
                        <div class="page-sub-header">
                            ...
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('soal.indexPenggalang') }}">Soal</a></li>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group local-forms mb-3">
                                            <input type="hidden" name="id" id="id" value="{{ $soal->id }}">
                                            <label>Persyaratan <span class="login-danger">*</span></label>
                                            <textarea name="persyaratan" id="persyaratan" rows="2" class="form-control">{{ $soal->persyaratan }}</textarea>
                                            <div class="invalid-feedback errorPersyaratan"></div>
                                        </div>
                                    </div>
                                    <div class="form-group local-forms mb-3">
                                        <label>Keterangan <span class="login-danger">*</span></label>
                                        <textarea name="keterangan" id="keterangan" rows="2" class="form-control">{{ $soal->keterangan }}</textarea>
                                    ...
                                    <div class="form-group local-forms mb-3">
                                        ...
                                        <select name="golongan" id="golongan" class="form-control">
                                            ...
                                            @foreach ($golongan as $row)
                                                <option value="{{ $row->id }}"
                                                    {{ $soal->golongan_id == $row->id ? 'selected' : '' }}>
                                                    {{ $row->name }}
                                                </option>
                                            @endforeach
                                        </select>
