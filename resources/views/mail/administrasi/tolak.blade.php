...
<body>
    <div class="container">
        <div class="header">
            <h2 style="color: #ffffff;">Mohon Maaf Belum Lolos Seleksi Administrasi <br>Pramuka Garuda</h2>
        </div>

        <p>Anda dinyatakan belum lolos dalam seleksi administrasi Pramuka Garuda. Berikut adalah detail pendaftaran Anda
            :
        </p>
        <table>
            <tr>
