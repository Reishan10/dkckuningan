...
<body>
    <div class="container">
        <div class="header">
            <h2 style="color: #ffffff;">Selamat Telah Lolos Seleksi Administrasi <br>Pramuka Garuda</h2>
        </div>

        <p>Anda telah berhasil lolos dalam seleksi administrasi Pramuka Garuda. Berikut adalah detail pendaftaran Anda :
        </p>
        <table>
            <tr>
