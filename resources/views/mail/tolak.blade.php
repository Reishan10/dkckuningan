...
<body>
    <div class="container">
        <div class="header">
            <h2 style="color: #ffffff;">Mohon Maaf Tidak Lolos Tahap 1 <br>Pramuka Garuda</h2>
        </div>

        <p>Anda dinyatakan tidak lolos dalam pendaftaran Pramuka Garuda tahap 1. Berikut adalah detail pendaftaran Anda
            :
        </p>
        <table>
            <tr>
