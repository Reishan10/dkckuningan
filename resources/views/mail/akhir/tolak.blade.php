...
<body>
    <div class="container">
        <div class="header">
            <h2 style="color: #ffffff;">Mohon Maaf Tidak Lolos Tahap Akhir <br>Pramuka Garuda</h2>
        </div>

        <p>Anda dinyatakan tidak lolos dalam pendaftaran Pramuka Garuda tahap akhir. Berikut adalah detail pendaftaran Anda
            :
        </p>
        <table>
            <tr>
