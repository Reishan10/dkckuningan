                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="card" id="user">
                                <div class="card-header">
                                    <h6>PENDAFTARAN PRAMUKA GARUDA</h6>
                                </div>
                                <form id="form">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="form-icon position-relative">
                                                            ...
                                                            <input type="text" class="form-control ps-5" name="kwaran"
                                                                id="kwaran" placeholder="Kwartir Ranting">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="form-icon position-relative">
                                                            <i data-feather="home" class="fea icon-sm icons"></i>
                                                            <input type="text" class="form-control ps-5" name="pangkalan"
